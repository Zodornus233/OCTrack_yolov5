    ...
    **Example**
    ...
    def predict(self, u=None, B=None, F=None, Q=None):
        ...
        if B is not None and u is not None:
            ...
            self.x = torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()+ \
                torch.mm(torch.from_numpy(B).to(torch.float32),torch.from_numpy(u).to(torch.float32)).numpy()
        else:
            #self.x = dot(F, self.x)
            self.x = torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()
        ...
        self.P = self._alpha_sq * torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(self.P).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(F.T).to(torch.float32)).numpy() + Q
    ...
    def update(self, z, R=None, H=None):
        ...
        #self.y = z - dot(H, self.x)
        self.y = z -torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()
        #torch.mm

        # common subexpression for speed
        #PHT = dot(self.P, H.T)
        PHT =torch.mm(torch.from_numpy(self.P).to(torch.float32),torch.from_numpy(H.T).to(torch.float32)).numpy()

        # S = HPH' + R
        # project system uncertainty into measurement space
        #self.S = dot(H, PHT) + R
        self.S = torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(PHT).to(torch.float32)).numpy() + R
        self.SI = self.inv(self.S)
        # K = PH'inv(S)
        # map system uncertainty into kalman gain
        # self.K = dot(PHT, self.SI)
        self.K = torch.mm(torch.from_numpy(PHT).to(torch.float32),torch.from_numpy(self.SI).to(torch.float32)).numpy()


        # x = x + Ky
        # predict new x with residual scaled by the kalman gain
        # self.x = self.x + dot(self.K, self.y)
        self.x = self.x + torch.mm(torch.from_numpy(self.K).to(torch.float32),torch.from_numpy(self.y).to(torch.float32)).numpy()
        ...
        I_KH = self._I - torch.mm(torch.from_numpy(self.K).to(torch.float32),
                                  torch.from_numpy(H).to(torch.float32)).numpy()
        #self.P = dot(dot(I_KH, self.P), I_KH.T) + dot(dot(self.K, R), self.K.T)
        self.P = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(I_KH).to(torch.float32),torch.from_numpy(self.P).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(I_KH.T).to(torch.float32)).numpy()+\
                 torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(self.K).to(torch.float32),torch.from_numpy(R).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(self.K.T).to(torch.float32)).numpy()
    ...
    def predict_steadystate(self, u=0, B=None):
        ...
        if B is not None:
            ...
            self.x = torch.mm(torch.from_numpy(self.F).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()+\
                     torch.mm(torch.from_numpy(B).to(torch.float32),torch.from_numpy(u).to(torch.float32)).numpy()
        else:
            #self.x = dot(self.F, self.x)
            self.x = torch.mm(torch.from_numpy(self.F).to(torch.float32),
                              torch.from_numpy(self.x).to(torch.float32)).numpy()
    ...
    def update_steadystate(self, z):
        ...
        self.y = z - torch.mm(torch.from_numpy(self.H).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()
    ...
    def update_correlated(self, z, R=None, H=None):
        ...
        self.S = torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(PHT).to(torch.float32)).numpy()+\
                 torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(self.M).to(torch.float32)).numpy()+\
                 torch.mm(torch.from_numpy(self.M.T).to(torch.float32),torch.from_numpy(H.T).to(torch.float32)).numpy()+R
        self.SI = self.inv(self.S)

        # K = PH'inv(S)
        # map system uncertainty into kalman gain
        #self.K = dot(PHT + self.M, self.SI)
        self.K = torch.mm(torch.from_numpy(PHT + self.M).to(torch.float32),torch.from_numpy(self.SI).to(torch.float32)).numpy()
        ...
        self.P = self.P -torch.mm(torch.from_numpy(self.K).to(torch.float32),torch.from_numpy(torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(self.P).to(torch.float32)).numpy() + self.M.T).to(torch.float32)).numpy()
    ...
    def rts_smoother(self, Xs, Ps, Fs=None, Qs=None, inv=np.linalg.inv):
        ...
        for k in range(n - 2, -1, -1):
            ...
            Pp[k] = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(Fs[k + 1]).to(torch.float32), torch.from_numpy(P[k]).to(torch.float32)).numpy()).to(torch.float32), torch.from_numpy(Fs[k + 1].T).to(torch.float32)).numpy() + Qs[k + 1]

            # pylint: disable=bad-whitespace
            #K[k] = dot(dot(P[k], Fs[k + 1].T), inv(Pp[k]))
            K[k] = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(P[k]).to(torch.float32), torch.from_numpy(Fs[k + 1].T).to(torch.float32)).numpy()).to(torch.float32), torch.from_numpy(inv(Pp[k])).to(torch.float32)).numpy()
            #x[k] += dot(K[k], x[k + 1] - dot(Fs[k + 1], x[k]))
            x[k] += torch.mm(torch.from_numpy(K[k]).to(torch.float32),torch.from_numpy(x[k + 1] - torch.mm(torch.from_numpy(Fs[k + 1]).to(torch.float32),torch.from_numpy(x[k]).to(torch.float32)).numpy()).to(torch.float32)).numpy()

            #P[k] += dot(dot(K[k], P[k + 1] - Pp[k]), K[k].T)
            P[k] += torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(K[k]).to(torch.float32), torch.from_numpy(P[k + 1] - Pp[k]).to(torch.float32)).numpy()).to(torch.float32), torch.from_numpy(K[k].T).to(torch.float32)).numpy()
    ...
    def get_prediction(self, u=None, B=None, F=None, Q=None):
        ...
        if B is not None and u is not None:
            ...
            x = torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()+\
                torch.mm(torch.from_numpy(B).to(torch.float32),torch.from_numpy(u).to(torch.float32)).numpy()
        else:
            #x = dot(F, self.x)
            x = torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy()
        ...
        P = self._alpha_sq * torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(self.P).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(F.T).to(torch.float32)).numpy() + Q
    ...
    def get_update(self, z=None):
       ...
       """
        ...
        # error (residual) between measurement and prediction
        #y = z - dot(H, x)
        y = z - torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(x).to(torch.float32)).numpy()

        # common subexpression for speed
        #PHT = dot(P, H.T)
        PHT = torch.mm(torch.from_numpy(P).to(torch.float32),torch.from_numpy(H.T).to(torch.float32)).numpy()

        # project system uncertainty into measurement space
        #S = dot(H, PHT) + R
        S = torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(PHT).to(torch.float32)).numpy()+R

        # map system uncertainty into kalman gain
        #K = dot(PHT, self.inv(S))
        K = torch.mm(torch.from_numpy(PHT).to(torch.float32),torch.from_numpy(self.inv(S)).to(torch.float32)).numpy()

        # predict new x with residual scaled by the kalman gain
        #x = x + dot(K, y)
        x = x + torch.mm(torch.from_numpy(K).to(torch.float32),torch.from_numpy(y).to(torch.float32)).numpy()

        # P = (I-KH)P(I-KH)' + KRK'
        #I_KH = self._I - dot(K, H)
        I_KH = self._I - torch.mm(torch.from_numpy(K).to(torch.float32),torch.from_numpy(H).to(torch.float32)).numpy()
        #P = dot(dot(I_KH, P), I_KH.T) + dot(dot(K, R), K.T)
        P = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(I_KH).to(torch.float32),torch.from_numpy(P).to(torch.float32)).numpy()).to(torch.float32), torch.from_numpy(I_KH.T).to(torch.float32)).numpy()+ \
            torch.mm(torch.from_numpy(
                torch.mm(torch.from_numpy(K).to(torch.float32), torch.from_numpy(R).to(torch.float32)).numpy()).to(
                torch.float32), torch.from_numpy(K.T).to(torch.float32)).numpy()
    ...
    def residual_of(self, z):
        ...
        return z - torch.mm(torch.from_numpy(self.H).to(torch.float32),torch.from_numpy(self.x_prior).to(torch.float32)).numpy()
    ...
    def measurement_of_state(self, x):
        ...
        #return dot(self.H, x)
        return torch.mm(torch.from_numpy(self.H).to(torch.float32),torch.from_numpy(x).to(torch.float32)).numpy()
    ...
    def mahalanobis(self):
        ...
        if self._mahalanobis is None:
            ...
            self._mahalanobis = sqrt(float(torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(self.y.T).to(torch.float32),torch.from_numpy(self.SI).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(self.y).to(torch.float32)).numpy()))
    ...
    def log_likelihood_of(self, z):
        ...
        return logpdf(z,torch.mm(torch.from_numpy(self.H).to(torch.float32),torch.from_numpy(self.x).to(torch.float32)).numpy(),self.S)
    ...
    def test_matrix_dimensions(self, z=None, H=None, R=None, F=None, Q=None):
        ...
        #Hx = dot(H, x)
        Hx = torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(x).to(torch.float32)).numpy()
...
def update(x, P, z, R, H=None, return_all=False):
    ...
    Hx = np.atleast_1d(torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(x).to(torch.float32)).numpy())
    ...
    # project system uncertainty into measurement space
    #S = dot(dot(H, P), H.T) + R
    S = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(P).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(H.T).to(torch.float32)).numpy() + R
    # map system uncertainty into kalman gain
    try:
        #K = dot(dot(P, H.T), linalg.inv(S))
        K = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(P).to(torch.float32),torch.from_numpy(H.T).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(linalg.inv(S)).to(torch.float32)).numpy()
    except:
        # can't invert a 1D array, annoyingly
        #K = dot(dot(P, H.T), 1. / S)
        K = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(P).to(torch.float32),torch.from_numpy(H.T).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(1. / S).to(torch.float32)).numpy()
    ...
    # P = (I-KH)P(I-KH)' + KRK'
    # KH = dot(K, H)
    KH = torch.mm(torch.from_numpy(K).to(torch.float32),torch.from_numpy(H).to(torch.float32)).numpy()
    ...
    if return_all:
        ...
        log_likelihood = logpdf(z,torch.mm(torch.from_numpy(H).to(torch.float32),torch.from_numpy(x).to(torch.float32)).numpy(),S)
...
def update_steadystate(x, z, K, H=None):
    ...
    #return x + dot(K, y)
    return x +  torch.mm(torch.from_numpy(K).to(torch.float32),torch.from_numpy(y).to(torch.float32)).numpy()
...
def predict(x, P, F=1, Q=0, u=0, B=1, alpha=1.):
    ...
    if np.isscalar(F):
        F = np.array(F)
    #x = dot(F, x) + dot(B, u)
    x = torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(x).to(torch.float32)).numpy()+ \
        torch.mm(torch.from_numpy(B).to(torch.float32), torch.from_numpy(u).to(torch.float32)).numpy()
    #P = (alpha * alpha) * dot(dot(F, P), F.T) + Q
    P = (alpha * alpha) * torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(F).to(torch.float32),torch.from_numpy(P).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(F.T).to(torch.float32)).numpy() + Q
...
def rts_smoother(Xs, Ps, Fs, Qs):
    ...
    for k in range(n - 2, -1, -1):
        ...
        pP[k] = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(Fs[k]).to(torch.float32),torch.from_numpy(P[k]).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(Fs[k].T).to(torch.float32)).numpy() + Qs[k]


        # pylint: disable=bad-whitespace
        #K[k] = dot(dot(P[k], Fs[k].T), linalg.inv(pP[k]))
        K[k] = torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(P[k]).to(torch.float32),torch.from_numpy(Fs[k].T).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(linalg.inv(pP[k])).to(torch.float32)).numpy()
        #x[k] += dot(K[k], x[k + 1] - dot(Fs[k], x[k]))
        x[k] += torch.mm(torch.from_numpy(K[k]).to(torch.float32),torch.from_numpy(x[k + 1] - torch.mm(torch.from_numpy(Fs[k]).to(torch.float32),torch.from_numpy(x[k]).to(torch.float32)).numpy()).to(torch.float32)).numpy()
        #P[k] += dot(dot(K[k], P[k + 1] - pP[k]), K[k].T)
        P[k] += torch.mm(torch.from_numpy(torch.mm(torch.from_numpy(K[k]).to(torch.float32),torch.from_numpy(P[k + 1] - pP[k]).to(torch.float32)).numpy()).to(torch.float32),torch.from_numpy(K[k].T).to(torch.float32)).numpy()
